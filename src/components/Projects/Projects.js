        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Tech-Log"
              description="TechLog is a collaborative platform for sharing and discussing tech content. It features user authentication, authorization, Log (post) creation, and real-time interactions. Designed for seamless use with Tailwind CSS and it also supports Logs and profile update features."
              ghLink="https://github.com/Darshan98Solanki/medium"
              demoLink="https://medium-ecru-six.vercel.app/"
              techStack={["TypeScript", "React", "Express", "Node", "PostgreSQL", "Prisma", "Tailwind CSS"]}
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              techStack={["TypeScript", "React", "Express","Node", "MongoDB", "Prisma", "Tailwind CSS"]}
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              demoLink="https://chat-dash-1.onrender.com"
              techStack={["TypeScript", "React", "Node", "WebSocket", "Tailwind CSS"]}
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              techStack={['Google Colab', 'Python', 'Talib', 'numpy', 'pandas', 'yfinance']}
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              techStack={["Python", "OpenCV", "CVZone"]}
            />
          </Col>
